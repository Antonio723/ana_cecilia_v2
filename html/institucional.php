        ...
        <aside id="menus">
            <nav class="normal_menu">
                <ul class="menu-screen">
                    ...
                    <li class="item_menu"><a href="institucional.php" class="text_menu selecionado">Institucional</a></li>
            ...
            <div class="partnerCards">
                ...
                <div class="partnerCard textPartener">
                    ...
                    <div class="partnerTexts">
                        ...
                        <p><a href="https://www.swengenhariaeconstrucoes.com.br/">swengenhariecons...</a></p>
                    </div>
                </div>
            </div>
        </div>
