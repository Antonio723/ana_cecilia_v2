    ...
    <aside id="menus">
        <nav class="normal_menu">
            <ul class="menu-screen">
                <li class="item_menu"><a href="home.php" class="text_menu" id="home">Home</a></li>
                <li class="item_menu"><a href="institucional.html" class="text_menu" id="institucional">Institucional</a></li>
                <li class="item_menu"><a href="acoes/acoes.html" class="text_menu" id="acoes">Nossas ações</a></li>
                <li class="item_menu causa"><a href="juntese.html" class="text_menu" id="juntese">Junte-se à causa</a></li>
                <li class="item_menu doacao"><a href="doacao.php" class="text_menu" id="doacao">QUERO DOAR</a></li>
            </ul>
        </nav>
        <nav class="mobile">
